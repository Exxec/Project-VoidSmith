# GUI.md
# Starsector Variant Generator GUI Design Contract
Version 0.5

This document defines the GUI architecture, interaction rules, rendering behavior, and user experience requirements for the Starsector Variant Generator.
